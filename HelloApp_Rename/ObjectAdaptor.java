...
public abstract class ObjectAdaptor extends org.omg.PortableServer.Servant
 implements HelloApp.HelloOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public ExtendsOthers _this() 
  {
    return ORBInterface.narrow(
    super._this_object());
  }

  public ExtendsOthers _this(org.omg.CORBA.ORB orb) 
  {
    return ORBInterface.narrow(
